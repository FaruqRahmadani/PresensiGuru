...
@section('content')
  <section>
    ...
    <div class="content-wrapper">
      <h3>
        @section('title')
          {{$Title = 'Tambah Data Status Sekolah'}}
        @endsection
        {{$Title}}
      </h3>
      <div class="row">
            ...
            <div class="panel-body">
              {!! Form::open(['url'=>Request::url(),'files'=>true,'class'=>'register-form', 'method' => 'POST', 'class' => 'form-horizontal', 'role' => 'form']) !!}
                <div class="form-group">
                  ...
                  <div class="col-lg-8">
                    <input class="form-control" type="text" name="NamaStatus" value="{{old('NamaStatus')}}" required pattern="[a-zA-Z0-9]+.{0,}" title="Minimal 1 Karakter" autofocus>
                  </div>
                </div>
